...
import com.rudra.aks.batch.listeners.ChunkListener;
import com.rudra.aks.batch.listeners.ItemProcessorListener;
import com.rudra.aks.batch.listeners.ItemReaderListener;
import com.rudra.aks.batch.listeners.ItemWriterListener;
import com.rudra.aks.batch.listeners.JobListener;
import com.rudra.aks.batch.listeners.StepListener;
...
public class BatchConfig {
    ...
    protected Step step1(ItemReader<UserBO> reader, ItemProcessor<UserBO, UserBO> processor, ItemWriter<UserBO> writer) {
        return steps.get("step1")
        			...
        			.reader(reader)
        				.listener(new ItemReaderListener<UserBO>())
        			.processor(processor)
